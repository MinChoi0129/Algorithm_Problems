...
#     def getMovableLocations(self, board):
...
#     def moveTo(self, location, board):
...
#     possible_locations = shark.getMovableLocations()
#     if not possible_locations: break

#     for location in possible_locations:
#         copied_board = DC(board)
#         old_shark_size = shark.size
#         shark.moveTo(location, copied_board)
#         if shark.size > old_shark_size:
