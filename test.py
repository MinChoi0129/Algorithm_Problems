...
description2 = Text("어느 한 여름, 태양은 미친듯이 뜨거워졌고 도라에몽은 쉬고 있었다...")
description3 = Text("지구온난화에도 불구하고 지독한 녀석인 모기는 살아있었다...")
description4 = Text("심기불편한 도라에몽을 모기가 시비걸기 시작하는데...")
...
# 각성한 도라에몽이 세상을 어둡게 만듦
for i in range(30):
    paper.setBackgroundColor((135 - i * 4, 206 - i * 6, 235 - i * 7))
    grass.setFillColor((255 - i * 8, 255 - i * 8, 0))
    sun.setFillColor((255 - i * 8, 55 - i, 0))
    sleep(0.1)
